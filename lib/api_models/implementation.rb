...
module SecureApi
  ...
  class Implementation < SecureApi::ApiControl    
    ...
    def routes
      {
        ...
        controller2: {
         ...
         notification_preferences: {
          get_get: {params: {username: :req, password: :req, opt1: :req, opt2: :opt, opt3: :opt } },
          create_post: {params: {username: :req, password: :req, opt1: :req, opt2: :opt, opt3: :opt } },      
          update_put: {params: {username: :req, password: :req, opt1: :req, opt2: :opt, opt3: :opt } },
    ...
    def notification_preferences_get_get
      KeepBusy.logger.info params.inspect 
      set_response  status: Response::OK , content_type: Response::JSON, content: {opt1: params[:opt1], opt2: params[:opt2], opt3: params[:opt3]} 
    end
